...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--accent)] text-[var(--accent-foreground)] shadow hover:bg-[var(--accent)]/90 hover:shadow-glow active:scale-[0.98]",
        secondary:
          "bg-[var(--accent-secondary)] text-[var(--accent-secondary-foreground)] shadow hover:bg-[var(--accent-secondary)]/90 active:scale-[0.98]",
        destructive:
          "bg-[var(--destructive)] text-[var(--destructive-foreground)] shadow-sm hover:bg-[var(--destructive)]/90",
        outline:
          "border border-[var(--border)] bg-transparent hover:bg-[var(--surface)] hover:border-[var(--foreground-subtle)] active:scale-[0.98]",
        ghost:
          "hover:bg-[var(--surface)] hover:text-[var(--foreground)] active:scale-[0.98]",
